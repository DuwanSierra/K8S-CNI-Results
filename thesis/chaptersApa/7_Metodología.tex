...
La decisión final aplica la suma ponderada $P_{CNI}=\sum_{i=1}^{n}(V_i \times W_i)$ definida en el Marco Teórico (sección~\ref{cap:marco_teorico}), donde los valores $V_i$ ya están normalizados en la escala $[1,\,5]$ y los pesos $W_i$ corresponden al perfil de usuario seleccionado.
